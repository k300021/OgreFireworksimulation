...
ConvexVolume::ConvexVolume(Ogre::AxisAlignedBox boundingBox, float offset)
{
    ...
    verts[0]= min.x; verts[1]= 0; verts[2]= max.z;
    verts[3]= max.x; verts[4]= 0; verts[5]= max.z;
    verts[6]= max.x; verts[7]= 0; verts[8]= min.z;
    verts[9]= min.x; verts[10]= 0; verts[11]= min.z;
